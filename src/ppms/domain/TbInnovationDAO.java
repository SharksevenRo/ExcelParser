...
public class TbInnovationDAO extends BaseHibernateDAO {
	...
	// property constants
	public static final String EMPLOYEE_ORG_ID = "employeeOrgId";
	...
	public List findByEmployeeOrgId(Object employeeOrgId) {
		return findByProperty(EMPLOYEE_ORG_ID, employeeOrgId);
	}
