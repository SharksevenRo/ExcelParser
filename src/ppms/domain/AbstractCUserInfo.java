...
public abstract class AbstractCUserInfo implements java.io.Serializable {
	...
	/** full constructor */
	public AbstractCUserInfo(BigDecimal operId, String operName,
			String operPass, String roleId, BigDecimal departId,
			BigDecimal centerId, Integer orgId, String zwId,
