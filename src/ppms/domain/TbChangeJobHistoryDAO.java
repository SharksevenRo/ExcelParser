...
public class TbChangeJobHistoryDAO extends BaseHibernateDAO {
	...
	// property constants
	public static final String OUT_JOB_ID = "outJobId";
	...
	public List findByOutJobId(Object outJobId) {
		return findByProperty(OUT_JOB_ID, outJobId);
	}

	public List findByInJobId(Object inJobId) {
		return findByProperty(IN_JOB_ID, inJobId);
	}
